...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    ...
    <>
      <div className="fixed top-0 left-0 right-0 z-40 flex justify-center items-center h-16 bg-black lg:hidden">
      ...
      <aside
        ...
        // }`}
        //   className={`
        //   fixed sm:relative left-0 top-0
        //   z-50 flex h-screen
        //   w-72.5 sm:w-80 md:w-96 lg:w-72.5
        ...
        // `}
        className={`
        fixed left-0 top-16 lg:top-0
        z-50 flex h-[calc(100vh-64px)] lg:h-screen
        w-72.5 sm:w-80 md:w-96 lg:w-72.5
        flex-col overflow-y-hidden
        bg-black duration-300 ease-linear
        dark:bg-boxdark
      ...
      >
        ...
        <div className="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
          ...
          <nav className="mt-4 sm:mt-6 lg:mt-9 px-4 sm:px-6">
            {/* <!-- Menu Group --> */}
            <div>
