...
// import { Table, Space, DatePicker, Input, Button, Spin, message } from 'antd';
...
//   const [filteredLogs, setFilteredLogs] = useState<LogDanhGia[]>([]);
//   const [messageApi, contextHolder] = message.useMessage();

//   const fetchLogs = async () => {
//     setLoading(true);
//     try {
//       const response = await fetch('http://172.16.0.60:883/api/log_danh_gia');
//       if (!response.ok) {
...
//   const columns: ColumnsType<LogDanhGia> = [
//     {
//       title: 'Thời gian',
//       dataIndex: 'thoi_gian',
//       key: 'thoi_gian',
...
//     {
//       title: 'Tiêu chí',
//       dataIndex: 'ten_tieuchi',
//       key: 'ten_tieuchi',
//     },
//     {
//       title: 'Tiểu mục',
//       dataIndex: 'ten_tieumuc',
//       key: 'ten_tieumuc',
//     },
//     {
//       title: 'Hành động',
...
//         <Table
//           columns={columns}
//           dataSource={filteredLogs.map((log, index) => ({
//             ...log,
//             key: index,
//           }))}
