...
// import LogoDark from '../../images/logo/ntp_logo_trim.png';
// import Logo from '../../images/logo/ntp_logo_trim.png';
// import Select from 'react-select';
// import {
//   DanhSachKhoaPhong,
//   DanhSachNhanVienToanVien,
...
//   const [khoaPhong, setKhoaPhong] = useState<any>(null);
...
//   const handleEncodeDangNhap = (data: any) => {
...
//       messageApi.open({
//         type: 'error',
//         content: `Đã có lỗi xảy ra trong quá trình lấy thông tin`,
//       });
//     }
//   };
...
//   useEffect(() => {
//     const fetchNhanVienToanVien = async () => {
//       try {
//         let data = await DanhSachNhanVienToanVien();
//         if (data) {
//           data = data.replace(/: NaN/g, ': null');
//           setDataNhanVienToanVien(JSON.parse(data));
//         }
//       } catch (error) {
//         console.log(error);
//         messageApi.open({
//           type: 'error',
//           content: `Đã có lỗi xảy ra trong quá trình danh sách nhân viên toàn viện`,
//         });
//       }
//     };
//     fetchNhanVienToanVien();
//   }, []);
...
//   const validateForm = () => {
//     let isValid = true;
//     const newErrors = { tenNhanVien: '', khoaPhong: '', password: '' };

//     if (!tenNhanVien && layThongTin === null) {
//       newErrors.tenNhanVien = 'Vui lòng chọn tên nhân viên';
//       isValid = false;
//     }

//     if (!khoaPhong && layThongTin === null) {
//       newErrors.khoaPhong = 'Vui lòng chọn khoa phòng';
//       isValid = false;
//     }

//     if (!password && layThongTin === null) {
...
//     <>
//       {contextHolder}
//       <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark p-11">
...
//               <p className="2xl:px-20">Đăng nhập vào hệ thống</p>
...
//                   />
//                   <path
//                     d="M203.062 278.617H170.68C170.121 278.617 169.584 278.394 169.189 277.999C168.793 277.604 168.571 277.068 168.57 277.009V265.168C168.571 264.609 168.793 264.073 169.189 263.678C169.584 263.283 170.121 263.06 170.68 263.06H203.062C203.621 263.06 204.158 263.283 204.553 263.678C204.949 264.073 205.171 264.609 205.172 265.168V276.509C205.171 277.068 204.949 277.604 204.553 277.999C204.158 278.394 203.621 278.617 203.062 278.617Z"
//                     fill="#3056D3"
//                   />
//                   <path
...
//                       options={
//                         layThongTin === null
//                           ? dataKhoaPhong.map((khoaPhong: any) => ({
//                               value: khoaPhong.TENGOIKHOAPHONG,
//                               label: khoaPhong.TENGOIKHOAPHONG,
//                             }))
//                           : undefined
//                       }
...
//                   <div className="relative">
//                     <input
//                       disabled={layThongTin === null ? false : true}
//                       style={{
//                         width: '100%',
//                         userSelect: 'none',
//                       }}
...
//                       value={
//                         layThongTin === null ? password : layThongTin?.mat_khau
//                       }
